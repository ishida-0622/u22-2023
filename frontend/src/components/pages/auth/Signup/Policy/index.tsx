...
export const Policy = () => {
  return (
    <div className={styles.policy}>
      <h1>プライバシーポリシー</h1>
      <p>
        東京情報クリエイター工学院専門学校プログラミング部（以下，「当団体」といいます。）は，本ウェブサイト上で提供するサービス「Puzzlish!」（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
      </p>
      <p>
        第1条（個人情報）
      ...
      <p>
        第2条（個人情報の収集方法）
        当団体は，ユーザーが利用登録をする際に氏名，メールアドレスなどの個人情報をお尋ねすることがあります。
      </p>
      <p>
        第3条（個人情報を収集・利用する目的）
      ...
      <p>
        1. 当団体サービスの提供・運営のため 2. 本人確認を行うため 3.
        ユーザーが利用中のサービスの新機能，更新情報等のメールを送付するため 4.
        メンテナンス，重要なお知らせなど必要に応じたご連絡のため 5.
      ...
      <p>
        ...
        (ア) 利用目的に第三者への提供を含むこと (イ)
        第三者に提供されるデータの項目 (ウ) 第三者への提供の手段または方法 (エ)
        本人の求めに応じて個人情報の第三者への提供を停止すること (オ)
        本人の求めを受け付ける方法
      </p>
      <p>
        ...
        2. 合併その他の事由による事業の承継に伴って個人情報が提供される場合 3.
      ...
      <p>
        ...
        2. 当団体の業務の適正な実施に著しい支障を及ぼすおそれがある場合 3.
        その他法令に違反することとなる場合
      ...
      <p>
        住所：〒101-0051 東京都千代田区神田神保町１丁目５０
        施設名：東京情報クリエイター工学院専門学校 担当：情報処理学科
        電話番号：03-3237-8711
      </p>
      <p>以上</p>
    </div>
