...
const handler = (
  ...
  const data: Puzzle = {
    ...
    icon: "https://k-ishida-u22-2023-mock.s3.ap-northeast-1.amazonaws.com/i+have+a+sword.png",
    words: [
      {
        word: "I",
        shadow:
      ...
      },
      {
        ...
        voice:
          "https://k-ishida-u22-2023-mock.s3.ap-northeast-1.amazonaws.com/gun.mp3",
        is_displayed: false,
        is_dummy: true,
      },
    ],
